...
export default function Home() {
      ...
      if (savedEmail) {
        ...
        setState({
          ...
          user: {
            ...
            surveyTarget: cachedData?.surveyTarget ?? 100,
            ...
            reservedBalance: cachedData?.reservedBalance ?? 0,
            isUnderReview: cachedData?.isUnderReview ?? false,
            reviewReason: cachedData?.reviewReason ?? null,
          },
        })
        setHydrated(true)
            ...
            if (res.ok) {
              ...
              setState(prev => ({
                ...
                user: {
                  ...
                  isUnderReview: data.isUnderReview ?? prev.user.isUnderReview,
                  reviewReason: data.reviewReason ?? prev.user.reviewReason,
                },
              }))
              ...
              setState(prev => ({
                ...
                user: {
                  ...
                  surveysCompleted: 0, surveyTarget: 100, earningRate: 0.005,
                  language: 'English (en)', inviteCode: '', unclaimedRevenue: 0,
                  referralEarnings: 0, friendsInvited: 0, totalEarned: 0, emailVerified: false,
                  firstname: '', lastname: '', newsletter: 'Yes', reservedBalance: 0,
                  isUnderReview: false, reviewReason: null,
                },
              }))
            }
          } catch {
  ...
  useEffect(() => {
    ...
    if (verifyStatus) {
      ...
      // eslint-disable-next-line react-hooks/set-state-in-effect -- setting state from URL params on mount
  ...
  const login = (email: string, emailVerified: boolean = false, userData?: Partial<AppState['user']>) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      localStorage.setItem('userData', JSON.stringify({
        ...
        surveyTarget: userData?.surveyTarget ?? 100,
        ...
        reservedBalance: userData?.reservedBalance ?? 0,
        isUnderReview: userData?.isUnderReview ?? false,
