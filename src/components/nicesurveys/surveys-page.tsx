    ...
    <div>
      ...
      <div className="mb-8">
          ...
          <div className="space-y-3">
            {[1, 2, 3].map(i => (
              <div key={i} className="bg-white rounded-[12px] border border-[#E2EAF1] p-4 animate-pulse" style={{ boxShadow: '0px 4px 20px 0px rgba(191,197,209,0.20)' }}>
                <div className="flex items-start gap-3">
                  <div className="w-[40px] h-[40px] rounded-lg bg-[#F0F2F5] flex-shrink-0" />
                  <div className="flex-1">
                    <div className="h-4 bg-[#F0F2F5] rounded w-48 mb-2" />
                    <div className="h-3 bg-[#F0F2F5] rounded w-full mb-2" />
                    <div className="flex gap-2">
                      <div className="h-5 bg-[#F0F2F5] rounded-full w-16" />
                      <div className="h-5 bg-[#F0F2F5] rounded-full w-20" />
                      <div className="h-5 bg-[#F0F2F5] rounded-full w-14" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        {!surveysLoading && surveys.length > 0 && (
          <div className="space-y-3 max-h-96 overflow-y-auto pr-1" style={{ scrollbarWidth: 'thin', scrollbarColor: '#0FBCC0 transparent' }}>
            {surveys.map(survey => (
              <div
                key={survey.id}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <h4 className="text-[14px] font-semibold text-[#36383A] truncate">
                        {survey.title}
                      </h4>
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-2">
                      ...
                      {/* Rating */}
                      {survey.rating > 0 && (
                        <span className="inline-flex items-center gap-1 text-[11px] text-[#F59E0B] bg-[#F59E0B]/10 rounded-full px-2 py-0.5">
