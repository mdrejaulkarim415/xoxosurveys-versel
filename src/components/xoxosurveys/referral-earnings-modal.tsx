        ...
        <div className="p-6 pb-4 border-b border-[#E2EAF1]">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="bg-[#E8F5E9] rounded-[10px] p-4 text-center">
              ...
              <p className="text-[22px] font-bold text-[#2E7D32]">${(data?.referralEarnings ?? state.user.referralEarnings).toFixed(3)}</p>
                  ...
                  <div key={record.id} className="flex items-center justify-between p-3 bg-[#F9FAFB] rounded-[8px]">
                    <div>
                      ...
                      <p className="text-[11px] text-[#999999]">
                        {new Date(record.createdAt).toLocaleDateString()} · Survey earned ${record.surveyReward.toFixed(3)}
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-[14px] font-bold text-[#2E7D32]">+${record.referralAmount.toFixed(3)}</p>
